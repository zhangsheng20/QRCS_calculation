function dom125 = read_gridpro(filename, startRow, endRow)
%IMPORTFILE 将文本文件中的数值数据作为矩阵导入。
%   DOM125 = IMPORTFILE(FILENAME) 读取文本文件 FILENAME 中默认选定范围的数据。
%
%   DOM125 = IMPORTFILE(FILENAME, STARTROW, ENDROW) 读取文本文件 FILENAME 的
%   STARTROW 行到 ENDROW 行中的数据。
%
% Example:
%   dom125 = importfile('dom-1-25.dat', 1, 49705);
%
%    另请参阅 TEXTSCAN。

% 由 MATLAB 自动生成于 2020/09/07 10:47:42
